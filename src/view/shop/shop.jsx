...
import { fetchShopDetail, fetchShopFoodMenu } from "../../api/shop"
import ShopEvaluate from '../shop_evaluate/shop_evaluate'
            ...
            <div className="shop-container">
                <header className="shop-detail-header">
                    ...
                    <div className="description-header">
                        <Link to={'/shopDetail/' + this.state.shopId} className="description-top">
                ...
                <ReactCSSTransitionGroup component={this.FirstChild} transitionName="shop" transitionEnterTimeout={200} transitionLeaveTimeout={300}>
                    {this.state.show ? 
                                      ...
                                      <div className='menu-detail-list' key={foodIndex}>
                                        <Link to='/shop/foodDetail' className='menu-detail-link'>
                                          ...
                                          <div className='menu-food-description'>
                                            <h3 className="food-description-head">
                                              <span className='description-foodname'>{food.name}</span>
                                              {
                                        ...
                                        <footer className='menu-detail-footer'>
                                              ...
                                              <div className='add-del-icon'>
                                                <i className='iconfont icon-subtraction' onClick={this.handleAddFoodCount.bind(this, food.num, -1)}></i>
                                                <div >{this.state.foodList[food.num].qty}</div>
                                                <i className='iconfont icon-plus' onClick={this.handleAddFoodCount.bind(this, food.num, 1)}></i>
                                              </div>
                                        </footer>
                                      </div>
                                    )
                    ...
                    <div className="buy-cart-container">
                      <div className='cart-icon-num'>
                        <div onClick={this.handleShowCart} className={this.state.count===0?"cart-icon-container":this.state.animate}>
                          ...
                          <i className='iconfont icon-cart cart_icon'></i>
                        </div>
                   ...
                   <div className='evaluate-area'>
                        <ShopEvaluate shopId={this.state.shopId}/>
                   </div>
                }
                </ReactCSSTransitionGroup>  
