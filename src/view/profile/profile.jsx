...
class Profile extends Component {
    ...
    getUserInfo = () => {
        ...
        fetchUserDetail().then(res => {
            userInfo = res.data
            userInfo.imgpath = userInfo.avatar
                    ...
                    <section key='s2'>
                        ...
                        <section className='profile-list'>
                            <QueueAnim deley='0.4'>          
                                ...
                                <Link to='/mall' className='myorder' key='i3'>
                                ...
                                <Link to='/membercard' className='myorder' key='i4'>
                                    <i className="iconfont icon-member"></i>
                                    <div className='myorder-text'>
                                        <span>饿疯了会员卡</span>
                                        <i className="iconfont icon-arrow-right"></i>
                                    </div>
                                </Link>
                                <Link to='/service' className='myorder' key='i5'>
